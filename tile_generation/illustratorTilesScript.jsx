...
let tile;
let tileDoc = app.activeDocument;

let paths = app.activeDocument.pathItems;
...
function illustratorDo(tiles) {
    for(let i = 0; i<tiles.length; i++) {
        ...
        let targetFile = getNewName(tile);
        
        let pngExportOpts = getPNGOptions();
    ...
    **********************************************************/
	...
	function getNewName(tile) {
		let ext, docName, newName, saveInFile, docName;
		ext = ".png";
		tile += ext;
    ...
    **********************************************************/
	...
	function getPNGOptions() {
		...
		let pngExportOpts = new ExportOptionsPNG24();
